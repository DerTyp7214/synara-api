...
- [Data Models](#data-models)
    ...
    - [ArtistSplitAlias](#artistsplitalias)
    ...
    - [DownloadFavType](#downloadfavtype)
    - [DownloadQueueEntry](#downloadqueueentry)
    - [DownloadSong](#downloadsong)
    - [Explicit](#explicit)
    - [FavSync](#favsync)
    - [FavouriteDownloadQueueEntry](#favouritedownloadqueueentry)
    - [FinishedDownloadQueueEntry](#finisheddownloadqueueentry)
    - [FlowPlaylist](#flowplaylist)
    ...
    - [Image](#image)
    - [Image](#image)
    - [ImageStreamItem](#imagestreamitem)
    - [InsertableAlbum](#insertablealbum)
    - [InsertableImage](#insertableimage)
    - [InsertablePlaylist](#insertableplaylist)
    - [InsertableSong](#insertablesong)
    - [LogLine](#logline)
    ...
    - [ProxyInfo](#proxyinfo)
    - [ProxyInstanceInfo](#proxyinstanceinfo)
    ...
    - [RemoteServerPaths](#remoteserverpaths)
    ...
    - [Track](#track)
    - [Type](#type)
    - [UrlDownloadQueueEntry](#urldownloadqueueentry)
    - [User](#user)
    - [UserInfo](#userinfo)
    - [UserPlaylist](#userplaylist)
    - [UserPlaylistBackup](#userplaylistbackup)
    - [UserPlaylistSong](#userplaylistsong)
    - [UserSong](#usersong)
    - [Version](#version)
- [RPC Services](#rpc-services)
    - [IAlbumService](#ialbumservice)
    - [IArtistService](#iartistservice)
    - [IAudioAnalysisService](#iaudioanalysisservice)
    - [IAuthService](#iauthservice)
    - [IBackupService](#ibackupservice)
    - [ICustomAudioService](#icustomaudioservice)
    - [IDbManagementService](#idbmanagementservice)
    - [IDiscoveryService](#idiscoveryservice)
    - [IDownloadService](#idownloadservice)
    - [IFavSyncService](#ifavsyncservice)
    - [IHandshakeService](#ihandshakeservice)
    - [IImageService](#iimageservice)
    - [IIndexer](#iindexer)
    - [ILyricsSearch](#ilyricssearch)
    - [ILyricsService](#ilyricsservice)
    - [IMetadataService](#imetadataservice)
    - [IMirrorService](#imirrorservice)
    - [IMusicBrainzService](#imusicbrainzservice)
    - [IPlaybackService](#iplaybackservice)
    - [IPlaylistService](#iplaylistservice)
    - [IReleaseService](#ireleaseservice)
    - [IRemoteMirrorService](#iremotemirrorservice)
    - [IScheduledTaskLogService](#ischeduledtasklogservice)
    - [IServerStatsService](#iserverstatsservice)
    - [ISessionService](#isessionservice)
    - [ISongService](#isongservice)
    - [IStorageService](#istorageservice)
    - [IUserPlaylistBackupService](#iuserplaylistbackupservice)
    - [IUserPlaylistService](#iuserplaylistservice)
...
| `scale` | [AudioScale](#audioscale)? | The scale of the song (major or minor). |
...
| `getSimilarSongsByPlaylist` | `playlistId` (`PlatformUUID`): The user playlist unique identifier to use as a seed.<br>`limit` (`Int`): The maximum number of results to return. | `List`<[UserSong](#usersong)> | No |  | Get songs similar to the songs in the provided user playlist. |
| `getSimilarSongsByBpm` | `seedSongIds` (`List`<`PlatformUUID`>): List of song unique identifiers to use as a seed.<br>`limit` (`Int`): The maximum number of results to return. | `List`<[UserSong](#usersong)> | No |  | Get songs with similar BPM to the provided seed tracks. |
| `getSimilarSongsByEnergy` | `seedSongIds` (`List`<`PlatformUUID`>): List of song unique identifiers to use as a seed.<br>`limit` (`Int`): The maximum number of results to return. | `List`<[UserSong](#usersong)> | No |  | Get songs with similar energy to the provided seed tracks. |
| `getSimilarSongsByMood` | `seedSongIds` (`List`<`PlatformUUID`>): List of song unique identifiers to use as a seed.<br>`limit` (`Int`): The maximum number of results to return. | `List`<[UserSong](#usersong)> | No |  | Get songs with similar mood (valence) to the provided seed tracks. |
...
| Function | Parameters | Returns | Admin | Errors | Description |
| :--- | :--- | :--- | :---: | :--- | :--- |
| `handshake` | - | [HandshakeResponse](#handshakeresponse) | No |  | Perform a handshake test to check server reachability and protocol support. |
...
| `byIds` | `ids` (`List`<`PlatformUUID`>): Collection of song IDs. | `List`<[UserSong](#usersong)> | No |  | Get multiple songs by their unique identifiers. |
...
| `addSongsToPlaylist` | `id` (`PlatformUUID`): The playlist unique identifier.<br>`songIds` (`List`<`PlatformUUID`>): Collection of song IDs to add. | `List`<`PlatformUUID`> | No |  | Add songs to a user playlist. |
| `addAlbumToPlaylist` | `id` (`PlatformUUID`): The playlist unique identifier.<br>`albumId` (`PlatformUUID`): The album unique identifier. | `List`<`PlatformUUID`> | No |  | Add all songs of an album to a user playlist. |
| `addPlaylistToPlaylist` | `id` (`PlatformUUID`): The target playlist unique identifier.<br>`sourcePlaylistId` (`PlatformUUID`): The source playlist unique identifier. | `List`<`PlatformUUID`> | No |  | Add all songs of a playlist to a user playlist. |
| `addUserPlaylistToPlaylist` | `id` (`PlatformUUID`): The target playlist unique identifier.<br>`sourcePlaylistId` (`PlatformUUID`): The source user playlist unique identifier. | `List`<`PlatformUUID`> | No |  | Add all songs of a user playlist to a user playlist. |
